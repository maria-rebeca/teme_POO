...
public class Autovehicul {
    ...
    private static final String PARCARE = "Parcare Iulius Mall";
    ...
    public void increase(int nrKmToIncrease) {
        setCurrentSpeed(getCurrentSpeed() + nrKmToIncrease);
    }

    public void increase(int nrKmToIncrease, int nrGear) {
        setCurrentSpeed(getCurrentSpeed() + nrKmToIncrease);
        setCurrentGear(nrGear);
    }

    public int drive(int kmToDrive) {
        return getCurrentSpeed() + kmToDrive;
    }
